    ...
    return (
      <div className="min-h-screen bg-[#E5FCFF] flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-[#43587C]">Loading your learning journey...</h2>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#E5FCFF] flex items-center justify-center">
        <div className="text-center max-w-md">
          <h2 className="text-2xl font-bold text-[#43587C] mb-4">Oops! Something went wrong</h2>
        ...
        <div className="mb-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-[#43587C] mb-2">{roadmap.title}</h1>
          ...
          <div className="bg-white rounded-xl p-6 shadow-[0_5px_15px_rgba(0,0,0,0.05)]">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div>
                <h2 className="text-xl font-bold text-[#2C3342] mb-1">Progress Overview</h2>
                <p className="text-[#2C3342]/70">14 lessons • Estimated completion: 2 weeks</p>
              </div>
              
              <div className="flex flex-col w-full md:w-1/3">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm font-medium text-[#2C3342]">0% Complete</span>
                  <span className="text-sm text-[#2C3342]/70">0/14 lessons</span>
                </div>
                <div className="h-2 w-full bg-[#E0E0E0] rounded-full overflow-hidden">
                  <div className="h-full bg-[#E17454] rounded-full" style={{ width: '0%' }}></div>
                </div>
              </div>
            </div>
          </div>
            ...
            >
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-[#2C3342]">Day {index + 1}: {lesson.title}</h3>
                  </div>
                </div>
              ...
              {expandedLessons[lesson._id] && (
                <div className="px-6 pb-6 border-t border-[#E0E0E0] pt-4">
                  <div className="mb-4">
                    <h4 className="text-lg font-medium text-[#43587C] mb-2">Overview</h4>
                    <p className="text-[#2C3342]/80">{lesson.overview}</p>
                  </div>
                  
                  <div>
                    <h4 className="text-lg font-medium text-[#43587C] mb-2">Key Questions</h4>
                    <ul className="space-y-2">
                      {lesson.questions.map((question, qIndex) => (
                        <li key={qIndex} className="flex items-start gap-2">
                          ...
                          <span className="text-[#2C3342]/80">{question}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
