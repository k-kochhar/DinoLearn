      ...
      try {
        ...
        const demoRoadmap = {
          ...
          lessons: Array.from({ length: 14 }, (_, i) => ({
            _id: `demo-lesson-${i}`,
            title: `${topic} Day ${i+1}`,
            overview: `This is a demonstration overview for learning ${topic} on day ${i+1}. In a real implementation, this would be generated by the AI based on your specific topic.`,
            questions: [
              `What are the fundamental concepts of ${topic}?`,
              `How can you apply ${topic} in real-world scenarios?`
            ]
          }))
        };
