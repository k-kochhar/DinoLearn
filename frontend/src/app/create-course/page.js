      ...
      try {
        ...
        const demoRoadmap = {
          ...
          lessons: Array.from({ length: 14 }, (_, i) => ({
            ...
            day: i + 1,
            title: `${topic} Day ${i + 1}`,
            summary: `This is a demonstration summary for learning ${topic} on day ${
              i + 1
            }. In a real implementation, this would be generated by the AI based on your specific topic.`,
            lesson: [
              {
                section: "Introduction",
                content: `Welcome to day ${
                  i + 1
                } of your ${topic} learning journey. This is demo content that would normally be generated by AI.`,
              },
              {
                section: "Key Concepts",
                content: `The key concepts for ${topic} on day ${
                  i + 1
              ...
              {
                section: "Practice",
                content: `Here are some practice exercises for ${topic} day ${
                  i + 1
                }.\n\n1. First practice item\n\n2. Second practice item`,
              },
              {
                section: "Summary",
                content: `This concludes your learning about ${topic} for day ${
                  i + 1
                }. Tomorrow we'll continue with more advanced topics.`,
              },
            ],
          })),
        };
        ...
        localStorage.setItem(
          `demoRoadmap-${demoRoadmapId}`,
          JSON.stringify(demoRoadmap)
        );
      ...
      <header className="bg-[#E5FCFF] py-5 px-6 border-b border-[#9EC1D9]/30 shadow-[0_4px_16px_rgba(0,0,0,0.03)]">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link
              href="/create-course"
              className="text-[#000000] font-bold border-b-2 border-[#E17454] pb-1"
            >
              Create Course
            </Link>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-[#2C3342]/70 text-lg">
              Our AI will generate a personalized 14-day learning roadmap based
          ...
          <div className="bg-white rounded-2xl p-8 shadow-[0_8px_30px_rgba(0,0,0,0.08)] mb-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label
                  htmlFor="topic"
                  className="block text-[#2C3342] font-medium mb-2"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#F5F5F5] rounded-xl p-6 border border-gray-100">
              ...
              <h3 className="text-lg font-bold mb-2 text-[#2C3342]">
                Personalized Learning
              </h3>
              <p className="text-[#2C3342]/70">
                Our AI creates a custom roadmap tailored to your specific
            ...
            <div className="bg-[#F5F5F5] rounded-xl p-6 border border-gray-100">
              ...
              <p className="text-[#2C3342]/70">
                A comprehensive plan that breaks down complex topics into
                manageable daily lessons.
              </p>
            </div>
            ...
            <div className="bg-[#F5F5F5] rounded-xl p-6 border border-gray-100">
              <div className="h-12 w-12 bg-[#9EC1D9]/30 rounded-lg flex items-center justify-center mb-4">
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09ZM18.259 8.715 18 9.75l-.259-1.035a3.375 3.375 0 0 0-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 0 0 2.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 0 0 2.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 0 0-2.456 2.456ZM16.5 20.25l-.259-1.035a3.375 3.375 0 0 0-2.456-2.456L12.75 16.5l1.035-.259a3.375 3.375 0 0 0 2.456-2.456L16.5 12.75l.259 1.035a3.375 3.375 0 0 0 2.456 2.456l1.035.259-1.035.259a3.375 3.375 0 0 0-2.456 2.456Z"
                  />
                </svg>
              </div>
              <h3 className="text-lg font-bold mb-2 text-[#2C3342]">
              ...
              <p className="text-[#2C3342]/70">
                High-quality lessons and quizzes created by advanced AI models
            ...
            <div className="bg-[#F5F5F5] rounded-xl p-6 border border-gray-100">
              ...
              <p className="text-[#2C3342]/70">
                Start learning right away with instantly generated courses on
                virtually any topic.
              </p>
            </div>
          </div>
