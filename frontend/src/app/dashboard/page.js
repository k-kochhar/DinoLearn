      ...
      <main className="max-w-7xl mx-auto pb-16">
        ...
        <div className="h-[25vh] flex flex-col items-center justify-center px-6 mt-8">
          <div className="max-w-2xl w-full">
            <h1 className="text-3xl font-bold text-[#43587C] mb-8 text-center">What would you like to learn today?</h1>
        ...
        <div className="min-h-[75vh] px-6 mt-8">
          <div className="bg-white rounded-3xl pt-12 pb-16 px-10 md:px-12 shadow-[0_8px_30px_rgba(0,0,0,0.08)]">
            <div className="mb-12 flex flex-col md:flex-row md:justify-between items-center gap-6">
              <div>
                <h2 className="text-2xl font-bold text-[#2C3342] mb-3">Your Learning Journey</h2>
                <p className="text-[#2C3342]/70">Continue where you left off or explore new courses</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-8">
              {filteredCourses.map(course => (
                ...
                >
                  ...
                  <h3 className="text-lg font-bold mb-2.5 line-clamp-2 text-[#2C3342]">{course.title}</h3>
                  <p className="text-sm text-[#2C3342]/70 mb-6">{course.category}</p>
                  
                  <div className="mt-auto">
                    <div className="flex items-center justify-between text-sm mb-3 text-[#2C3342]">
                      <span className="font-medium">Progress</span>
                      <span className="font-bold text-[#2C3342]">{course.progress}%</span>
                    </div>
